...
public class CalendarView extends View implements View.OnTouchListener {
	...
	private void drawCellBg(Canvas canvas, int index, int color) {
		...
		Log.i("chenghao", "left="+left)	;	
		Log.i("chenghao", "top="+top)	;	
		Log.i("chenghao", "right="+(left + surface.cellWidth- surface.borderWidth))	;
		Log.i("chenghao", "bot="+(top + surface.cellHeight- surface.borderWidth))	;	

		float right=left + surface.cellWidth- surface.borderWidth;
		float bot=top + surface.cellHeight- surface.borderWidth;
		float x2=(right-left)/2;
		float y2=(bot-top)/2;
		canvas.drawCircle(left+x2, top+y2+20, 50, surface.cellBgPaint);
	}
	...
	private class Surface {
		...
		public int cellSelectedColor = Color.parseColor("#00cca8");
